...
const permAddressSchema = new mongoose.Schema({
...
permAddressSchema.pre('save', async function (next) {
...
module.exports = mongoose.model('LeaderPermAddress', permAddressSchema);
